        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-6">
              株式会社WellnessCreateは、「～「Life style」に「Wellness」を浸透させる～」というビジョンのもと、
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800">販売代理店事業</h2>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                <li>メーカーからの業務委託により商品を仕入れ、顧客に販売するフロー</li>
                <li>メーカーは製造・納品を担当し、WellnessCreateは販売を担当する連携構造</li>
                <li>お客様の健康と身体づくりというWellnessの理念に合致した商品を厳選</li>
              </ul>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800">Sportsメディア事業</h2>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                <li>マイナースポーツ専門のオウンドメディア「M Sports」を運営</li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                <li>AARRRモデルを採用（Acquisition、Activation、Retention、Referral、Revenue）</li>
                <li>ユーザー獲得→活性化→継続利用→紹介拡散→収益最大化の段階的成長</li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                ...
                <li>パートナー企業（アスリート向け商品企業、広告出店企業）からの広告収入</li>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                <li>マイナースポーツの認知拡大</li>
                <li>「かっこいいプレイ」の共有によるユーザーのスポーツ参加意欲向上</li>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 italic">
              両事業は「Wellness」を軸に展開され、健康を手段として身体的・精神的・社会的に充実した「Life style」の確立と自己実現を支援することを目的としています。
            </p>
          </div>
        </div>
