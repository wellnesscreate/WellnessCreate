  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-gray-50 rounded-lg p-8 shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center mb-4 text-gray-800">スポーツメディア事業</h3>
              <p className="text-gray-600 text-center">
                健康とウェルネスに関する情報を発信するメディア運営を行っています。
                最新のスポーツトレンドや健康情報を提供し、人々の健康的な生活をサポートします。
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-8 shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center mb-4 text-gray-800">代理店事業</h3>
              <p className="text-gray-600 text-center">
                健康関連商品・サービスの代理店として、厳選された商品を提供しています。
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <table className="w-full">
                  <tbody>
                    <tr className="border-b border-gray-200">
                      <th className="py-4 text-left text-gray-600 font-semibold w-1/3">会社名</th>
                      <td className="py-4 text-gray-800">株式会社WellnessCreate</td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <th className="py-4 text-left text-gray-600 font-semibold">設立年月日</th>
                      <td className="py-4 text-gray-800">2024年9月6日</td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <th className="py-4 text-left text-gray-600 font-semibold">代表者名</th>
              ...
              <div>
                <table className="w-full">
                  <tbody>
                    <tr className="border-b border-gray-200">
                      <th className="py-4 text-left text-gray-600 font-semibold w-1/3">事業内容</th>
                    ...
                    <tr className="border-b border-gray-200">
                      <th className="py-4 text-left text-gray-600 font-semibold">所在地</th>
                      <td className="py-4 text-gray-800">
                        〒150-0021<br />
                        東京都渋谷区恵比寿西二丁目8番4号<br />
                        EX恵比寿西ビル5階
                      </td>
                    </tr>
                    <tr className="border-b border-gray-200">
                      <th className="py-4 text-left text-gray-600 font-semibold">連絡先</th>
                      <td className="py-4 text-gray-800">
                        080-3087-6970<br />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">経営陣</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-gray-50 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center mb-2 text-gray-800">小原 直起</h3>
              <p className="text-gray-600 text-center font-semibold mb-2">代表取締役</p>
            ...
            <div className="bg-gray-50 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center mb-2 text-gray-800">星野 真吾</h3>
              <p className="text-gray-600 text-center font-semibold mb-2">取締役</p>
              <p className="text-sm text-gray-500 text-center">
            ...
            <div className="bg-gray-50 rounded-lg p-6 shadow-md hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-bold text-center mb-2 text-gray-800">大見謝 拓馬</h3>
              <p className="text-gray-600 text-center font-semibold mb-2">取締役</p>
              <p className="text-sm text-gray-500 text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative border-l-2 border-green-500 pl-8 pb-8">
              ...
              <div className="mb-4">
                <span className="text-lg font-bold text-green-600">2024年9月</span>
                <h3 className="text-xl font-bold text-gray-800 mt-1">会社設立</h3>
            ...
            <div className="relative border-l-2 border-green-500 pl-8">
              <div className="absolute w-4 h-4 bg-green-500 rounded-full -left-2 top-0"></div>
              <div>
                <span className="text-lg font-bold text-green-600">2025年2月</span>
                <h3 className="text-xl font-bold text-gray-800 mt-1">代理店契約</h3>
                <p className="text-gray-600 mt-2">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">パートナーシップ</h2>
          
          <div className="max-w-4xl mx-auto bg-gray-50 rounded-lg shadow-md p-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:ml-8 flex-1">
                <h3 className="text-xl font-bold mb-2 text-center md:text-left text-gray-800">株式会社CANLIFE</h3>
